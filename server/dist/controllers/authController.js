...
exports.validateResetToken =
  ...
  exports.unbanUser =
  exports.banUser =
  exports.getPendingIdVerifications =
  exports.verifyUserIdDocument =
  exports.uploadIdVerification =
  exports.verifyPhoneWithOTP =
  exports.initiatePhoneVerification =
  exports.sendPhoneVerificationOTP =
  exports.verifyEmailWithOTP =
  exports.resendEmailVerification =
  exports.initiateEmailVerification =
...
const sendEmailVerificationOTP = (userId, email) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      yield OtpVerification_1.default.deleteMany({
        user: userId,
        type: 'email',
      });
...
const initiateEmailVerification = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const resendEmailVerification = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      // Send OTP
      const result = yield (0, exports.sendEmailVerificationOTP)(
        userId,
        user.email
      );
      if (result) {
...
const verifyEmailWithOTP = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const user = ensureAuthenticated(req, res);
      if (!user) return;
...
const sendPhoneVerificationOTP = (userId, phoneNumber) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      // Generate 6-digit OTP
      const otp = Math.floor(100000 + Math.random() * 900000).toString();
...
const initiatePhoneVerification = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const currentUser = ensureAuthenticated(req, res);
      if (!currentUser) return;
      ...
      // Send OTP
      const result = yield (0, exports.sendPhoneVerificationOTP)(
        userId,
        phoneNumber
      );
      if (result) {
...
const verifyPhoneWithOTP = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const user = ensureAuthenticated(req, res);
      if (!user) return;
...
const uploadIdVerification = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const user = ensureAuthenticated(req, res);
      if (!user) return;
...
const verifyUserIdDocument = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getPendingIdVerifications = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const admin = ensureAdmin(req, res);
      if (!admin) return;
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      res.status(200).json({
        ...
        user: Object.assign(Object.assign({}, req.user.toObject()), {
          password: undefined,
        }),
      });
    } catch (error) {
