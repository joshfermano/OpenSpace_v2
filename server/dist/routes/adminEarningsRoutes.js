...
const adminEarningsController = __importStar(require("../controllers/adminEarningsController"));
...
// Revenue analysis
router.get('/revenue-summary', adminEarningsController.getPlatformRevenueSummary);
...
router.get('/host-payout/:hostId', adminEarningsController.getHostPayoutDetails);
